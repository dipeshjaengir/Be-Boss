    ...
    >
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          {review.verified && (
            <span className="inline-flex items-center space-x-1 text-[10px] uppercase font-bold text-[#B08D57] px-2.5 py-0.5 rounded-sm bg-[#B08D57]/15 border border-[#B08D57]/30">
