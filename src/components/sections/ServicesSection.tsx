    ...
    <Section id="services" variant="default" padding="lg">
      <div className="space-y-16">
        ...
        <div className="space-y-4 max-w-3xl text-left">
          ...
          <p className="text-base text-[#A19B91] leading-relaxed font-normal max-w-2xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-4 sticky top-28 space-y-6">
            <div className="relative rounded-3xl overflow-hidden border border-white/10 bg-[#232323] h-[480px] shadow-2xl group">
              <img
              ...
              {/* Quote Overlay */}
              <div className="absolute bottom-6 left-6 right-6 p-5 rounded-2xl bg-[#171717]/90 backdrop-blur-md border border-white/10 space-y-2">
            ...
            {/* Guarantee Note */}
            <div className="p-5 rounded-2xl bg-[#232323] border border-white/10 space-y-3 text-xs text-[#A19B91]">
              <div className="flex items-center space-x-2 text-[#B08D57]">
                <ShieldCheck className="w-4 h-4 shrink-0" />
                <span className="font-semibold text-white">Transparent Pricing Policy</span>
              </div>
          ...
          <div className="lg:col-span-8 space-y-6">
            {/* Category Tabs */}
            <div className="flex flex-wrap items-center gap-2 p-1.5 rounded-2xl bg-[#232323] border border-white/10">
              {categories.map((cat) => {
