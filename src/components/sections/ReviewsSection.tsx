...
export const ReviewsSection: React.FC = () => {
  return (
    <Section id="reviews" variant="default" padding="lg">
      <div className="space-y-12 text-center">
        ...
        <div className="max-w-4xl mx-auto p-6 sm:p-8 rounded-xl bg-[var(--card-bg)] border border-[var(--border-card)] flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl">
          {/* Rating Score */}
          ...
          <div className="w-full md:w-64 space-y-1.5 text-xs text-[var(--text-muted)]">
            <div className="flex items-center justify-between">
              <span>5 Star Reviews</span>
              <span className="text-[#B08D57] font-bold">98%</span>
            </div>
            <div className="w-full h-2 rounded-full bg-[var(--site-bg)] overflow-hidden">
        ...
        <Grid cols={3} gap="md" className="text-center max-w-4xl mx-auto">
          <div className="p-4 rounded-xl bg-[var(--card-bg)] border border-[var(--border-card)] space-y-1 shadow-sm">
            <div className="flex items-center justify-center space-x-1 text-[#B08D57]">
              <Award className="w-4 h-4" />
              <span className="font-display font-bold text-xl text-[var(--text-main)]">99%</span>
            </div>
            <p className="text-[11px] text-[var(--text-muted)]">Client Satisfaction</p>
          </div>

          <div className="p-4 rounded-xl bg-[var(--card-bg)] border border-[var(--border-card)] space-y-1 shadow-sm">
            <div className="flex items-center justify-center space-x-1 text-[#B08D57]">
              <RefreshCw className="w-4 h-4" />
              <span className="font-display font-bold text-xl text-[var(--text-main)]">88%</span>
            </div>
            <p className="text-[11px] text-[var(--text-muted)]">Repeat Retention Rate</p>
          </div>

          <div className="p-4 rounded-xl bg-[var(--card-bg)] border border-[var(--border-card)] space-y-1 shadow-sm">
            <div className="flex items-center justify-center space-x-1 text-[#B08D57]">
              <Users className="w-4 h-4" />
              <span className="font-display font-bold text-xl text-[var(--text-main)]">10,000+</span>
            </div>
            <p className="text-[11px] text-[var(--text-muted)]">Cuts Delivered In Portsmouth</p>
          </div>
        </Grid>
