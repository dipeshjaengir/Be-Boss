    ...
    <>
      <AnimatePresence>
        <motion.aside
          ...
          className="fixed bottom-4 left-4 right-4 md:left-6 md:right-auto md:max-w-xl z-[700] p-5 sm:p-6 bg-[var(--card-bg)]/95 backdrop-blur-xl border border-[#B08D57]/30 rounded-xl shadow-2xl text-[var(--text-main)] transition-colors duration-500"
